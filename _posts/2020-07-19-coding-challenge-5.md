---
title: "[Coding Challenge] BOJ 백준 3055 (탈출)"
...
못 풀어서 한번 포기했다가 다시 푼 문제. 모르겠어서 다른 사람들이 푼 풀이를 참고해서 풀었다. 물의 이동을 BFS로 먼저 수행한 후에 고슴도치 움직임을 생각해야 한다. 물은 이동하면서 몇 초에 도달했는지 저장을 해놓고 고슴도치를 움직일 때 그 칸에 물이 차지 않았거나 물이 차기 전이라면 이동시키는 방식으로 풀이했다.