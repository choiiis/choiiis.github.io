---
title: "[Coding Challenge] BOJ 백준 7562 (나이트의 이동)"
...
dx와 dy 행렬의 원소만 좀 차이가 있을 뿐 이전의 BFS 문제들과 비슷했다. 또 차이가 있다면, start와 fin이 일치할 경우 BFS를 끝나게 하는 것도 구현해주어야 하고 테스트 케이스마다 행렬들을 초기화해주어야 한다.